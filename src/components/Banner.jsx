      ...
      <div className="container mx-auto">
        <div className='flex flex-col gap-y-8 lg:items-center lg:gap-x-12 lg:flex-row'>
          <div>
            ...
            <div className='mb-6 text-[36px] lg:text-[60px] font-secondary font-semibold text-center uppercase leading - [1] lg:text-left'><span className='mr-4 text-white'>I am a</span>
              <TypeAnimation sequence={[
                ...
                'Freelancer',
                2000
              ]} speed={50} className='text-accent' wrapper='span' repeat={Infinity} /></div>
            <p className='mb-8 max-w-lg mx-auto lg:mx-0'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus dignissimos voluptas, culpa harum commodi tem</p>
            <div className='flex max-w-max gap-x-6 items-center mb-12 mx-auto lg:mx-0'><button className='btn btn-lg'>Contact me</button>
          ...
          <div className='hidden lg:flex flex-1 max-w-[320px] lg:max-w-[482px]'> <img src={Image} alt="" /></div>
        </div>
      </div>
    </section>
  )
